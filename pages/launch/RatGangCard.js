...
export default function RatGangCard() {
  const [walletConnected, setWalletConnected] = useState(false);
  return (
    <div className='bg-[#16151A] rounded-lg p-24'>
      <div className='grid grid-cols-2 gap-x-80'>
        <div>
          ...
          <p className='text-gray-200 text-5xl capitalize mt-12'>Rat Gang</p>

          <div className='grid grid-cols-3 gap-x-4 mt-6'>
            <div className='bg-[#1B2331] rounded-md p-3'>
              <p className='text-gray-300 uppercase text-md'>Items</p>
              <p className='text-gray-300 uppercase text-md font-medium'>4,4132</p>
            </div>
            <div className='bg-[#1B2331] rounded-md p-3'>
              <p className='text-gray-300 uppercase text-md'>Price</p>
              <p className='text-gray-300 uppercase text-md font-medium'>4,4132</p>
            </div>
            <div></div>
          </div>
        ...
        <div>
          <div className='w-full'>
            <Image src={`/assets/images/${walletConnected ? 'mint' : 'rat_gang'}.png`} width={540} height={423} alt='' className='rounded-lg' />
          </div>
          ...
          <div className='mt-5'>
            ...
            <p className='text-gray-200 text-sm text-right mt-3'>80% (120/96)</p>
          </div>
        </div>
      </div>
    </div>
