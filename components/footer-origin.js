...
function Footer() {
	return (
		<footer className='bg-darkgray' aria-labelledby='footer-heading'>
			...
			<div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
				...
				<div className='border-t border-gray-700 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0'>
					<div>
						<h3 className='text-sm font-semibold text-gray-400 tracking-wider uppercase'>
							Subscribe the VAULT3D newsletter
						</h3>
						<p className='mt-2 text-base text-gray-300'>
							Our newsletter features our latest news, articles, and resources,
							all sent to your inbox weekly!
						</p>
					</div>
					<form
						action='https://getvault3d.us20.list-manage.com/subscribe/post?u=df408b1919be1a10ed3be4451&amp;id=2f333da15d'
						method='post'
						id='mc-embedded-subscribe-form'
						name='mc-embedded-subscribe-form'
						className='validate mt-4 sm:flex sm:max-w-md lg:mt-0'
						target='_blank'
						noValidate
					>
				...
				<div className='mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between'>
					...
					<p className='mt-8 text-base text-gray-400 md:mt-0 md:order-1'>
						&copy; 2022 VAULT3D. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
